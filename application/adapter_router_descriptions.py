"""Load router tool schemas from adapter retriever *_description constants.

Maps each spec name to the description dict authored in adapter/retrievers.
"""
...
ADAPTER_DESCRIPTION_SOURCES: dict[str, tuple[str, str]] = {
    "quy_dinh_chung_khai_niem_phap_ly": (
        "adapter.retrievers.quy_dinh_chung_khai_niem_phap_ly",
        "quy_dinh_chung_khai_niem_phap_ly_description",
    ),
    "dieu_kien_ket_hon": (
        "adapter.retrievers.ket_hon.dieu_kien_ket_hon",
        "dieu_kien_ket_hon_description",
    ),
    "dang_ky_ket_hon": (
        "adapter.retrievers.ket_hon.dang_ky_ket_hon",
        "dang_ky_ket_hon_description",
    ),
    "ket_hon_trai_phap_luat": (
        "adapter.retrievers.ket_hon.ket_hon_trai_phap_luat",
        "ket_hon_trai_phap_luat_description",
    ),
    "chung_song_nhu_vo_chong": (
        "adapter.retrievers.ket_hon.chung_song_nhu_vo_chong",
        "chung_song_nhu_vo_chong_description",
    ),
    "hon_nhan_cham_dut_do_vo_chong_chet": (
        "adapter.retrievers.hon_nhan_cham_dut_do_vo_chong_chet",
        "hon_nhan_cham_dut_do_vo_chong_chet_description",
    ),
    "quy_dinh_chung_ly_hon": (
        "adapter.retrievers.ly_hon.quy_dinh_chung_ly_hon",
    ...
    "cha_me_con_sau_ly_hon": (
        "adapter.retrievers.ly_hon.cha_me_con_sau_ly_hon",
        "cha_me_con_sau_ly_hon_description",
    ),
    "cap_duong": (
        "adapter.retrievers.cap_duong",
