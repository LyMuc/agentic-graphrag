...
\usepackage[top=2cm, bottom=2cm, left=3.5cm, right=2.5cm, headheight=35pt]{geometry}
...
% TikZ phục vụ Chương 4: package diagram, class diagram, sequence diagram, routing flow
\usepackage{tikz}
...
\begin{center}
    \textbf{\MakeUppercase{DANH MỤC THUẬT NGỮ VÀ TỪ VIẾT TẮT}}
\end{center}
