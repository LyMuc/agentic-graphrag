...
class NghiDinhGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Nghị định 10/2015/NĐ-CP
        self.base_id = "NghiDinh_10_2015_ND_CP"
        self.common_props = {
            "loai_van_ban": "Nghị định",
            "ngay_ban_hanh": "2015-01-28",
            "ngay_co_hieu_luc": "2015-03-15",
    ...
    def parse_and_insert(self, file_path):
        ...
        nghi_dinh_info = {
            "id": self.base_id,
            "so_hieu": "10/2015/NĐ-CP",
            "ten_van_ban": "Nghị định Quy định về sinh con bằng kỹ thuật thụ tinh trong ống nghiệm và điều kiện mang thai hộ vì mục đích nhân đạo",
            "co_quan_ban_hanh": "Chính phủ",
            "noidung": "Nghị định Quy định về sinh con bằng kỹ thuật thụ tinh trong ống nghiệm và điều kiện mang thai hộ vì mục đích nhân đạo"
        }
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Nghị định 10/2015/NĐ-CP.")
...
if __name__ == "__main__":
    ...
    # Đường dẫn file Docx (Lưu ý: phải chuyển sang .docx để python-docx đọc được)
    base_dir = os.path.dirname(os.path.abspath(__file__))
    FILE_PATH = os.path.join(base_dir, "10_2015_ND-CP_264622.docx")
    ...
    try:
        if os.path.exists(FILE_PATH):
            ...
            print(f"Không tìm thấy file: {FILE_PATH}. Vui lòng mở file .doc bằng Word và lưu lại thành .docx!")
    finally:
        builder.close()