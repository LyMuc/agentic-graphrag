...
class NghiDinhGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Nghị định 144/2021/NĐ-CP
        self.base_id = "NghiDinh_144_2021_ND_CP"
        self.common_props = {
            "loai_van_ban": "Nghị định",
            "ngay_ban_hanh": "2021-12-31",
            "ngay_co_hieu_luc": "2022-01-01",
            "ngay_het_hieu_luc": "",
    ...
    def parse_and_insert(self, file_path):
        ...
        nghi_dinh_info = {
            "id": self.base_id,
            "so_hieu": "144/2021/NĐ-CP",
            "ten_van_ban": "Nghị định quy định xử phạt vi phạm hành chính trong lĩnh vực an ninh, trật tự, an toàn xã hội; phòng, chống tệ nạn xã hội; phòng cháy, chữa cháy; cứu nạn, cứu hộ; phòng, chống bạo lực gia đình",
            "co_quan_ban_hanh": "Chính phủ",
            "noidung": "Nghị định quy định xử phạt vi phạm hành chính trong lĩnh vực an ninh, trật tự, an toàn xã hội; phòng, chống tệ nạn xã hội; phòng cháy, chữa cháy; cứu nạn, cứu hộ; phòng, chống bạo lực gia đình"
        }
        ...
        for line in lines:
            # 1. XỬ LÝ TRONG TRÍCH ĐOẠN (cho các quy định sửa đổi bổ sung)
            if is_quoting:
                if active_entity:
            ...
            # Nhận diện Điều (ID PascalCase: _Dieu_)
            ...
            # Nhận diện Khoản (ID PascalCase: _Khoan_)
            ...
            # Nhận diện Điểm (ID PascalCase: _Diem_)
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Nghị định 144/2021.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "144_2021_ND-CP_425471.docx")
