...
class BoLuatGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Bộ luật Hình sự 2015
        self.base_id = "BoLuat_HinhSu_2015"
        self.common_props = {
    ...
    def parse_and_insert(self, file_path):
        ...
        # Thông tin của node gốc Luat (Bộ luật)
        luat_info = {
            "id": self.base_id,
        ...
        # Tracking trạng thái cấu trúc (Bộ luật thường có thêm Phần)
        current_phan = ""
        ...
        # Regex nhận diện tiêu chuẩn (Thêm Phần cho Bộ luật)
        ...
        for line in lines:
            ...
            if chuong_match := chuong_pattern.match(line):
                # Gộp tên Phần và Chương để lưu vào field `chuong` (VD: Phần thứ nhất - Chương I)
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Bộ luật Hình sự 2015.")
...
if __name__ == "__main__":
    ...
    # Nhớ Save As file .doc thành .docx trước khi chạy đoạn này nhé!
    base_dir = os.path.dirname(os.path.abspath(__file__))
    FILE_PATH = os.path.join(base_dir, "100_2015_QH13_296661.docx")
