...
class NghiDinhGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Nghị định 207/2025/NĐ-CP
        self.base_id = "NghiDinh_207_2025_ND_CP"
        self.common_props = {
            "loai_van_ban": "Nghị định",
            "ngay_ban_hanh": "2025-07-15",
    ...
    def parse_and_insert(self, file_path):
        ...
        nghi_dinh_info = {
            ...
            "ten_van_ban": "Nghị định quy định về sinh con bằng kỹ thuật hỗ trợ sinh sản và điều kiện mang thai hộ vì mục đích nhân đạo",
            "co_quan_ban_hanh": "Chính phủ",
            "noidung": "Nghị định quy định về sinh con bằng kỹ thuật hỗ trợ sinh sản và điều kiện mang thai hộ vì mục đích nhân đạo"
        }
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Nghị định 207/2025/NĐ-CP.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "207_2025_ND-CP_306858.docx")
