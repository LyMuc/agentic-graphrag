...
class NghiDinhGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Nghị định 126/2014/NĐ-CP
        self.base_id = "NghiDinh_126_2014_ND_CP"
        self.common_props = {
            "loai_van_ban": "Nghị định",
            "ngay_ban_hanh": "2014-12-31",
            "ngay_co_hieu_luc": "2015-02-15",
    ...
    def parse_and_insert(self, file_path):
        ...
        # Thông tin node gốc NghiDinh
        nghi_dinh_info = {
            "id": self.base_id,
            "so_hieu": "126/2014/NĐ-CP",
            "ten_van_ban": "Nghị định quy định chi tiết một số điều và biện pháp thi hành Luật Hôn nhân và gia đình",
            "co_quan_ban_hanh": "Chính phủ",
            "noidung": "Nghị định quy định chi tiết một số điều và biện pháp thi hành Luật Hôn nhân và gia đình"
        }
        ...
        # Regex nhận diện các cấp bậc chính
        ...
        for line in lines:
            ...
            if is_quoting:
                ...
                # Kiểm tra kết thúc trích đoạn: dấu .” hoặc ;”
        ...
        print(f"Đã hoàn tất bóc tách Nghị định 126/2014. Tổng cộng: {len(articles)} Điều.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "126_2014_ND-CP_262379.docx")
