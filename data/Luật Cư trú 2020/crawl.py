...
class LuatCuTruGraphBuilder:
    def __init__(self, uri, user, password):
        self.driver = GraphDatabase.driver(uri, auth=(user, password))
        
        # ID gốc và các thông tin chung của Luật Cư trú 2020
        self.base_id = "Luat_CuTru_2020"
        self.common_props = {
            "loai_van_ban": "Luật",
            "ngay_ban_hanh": "2020-11-13",
            "ngay_co_hieu_luc": "2021-07-01",
    ...
    def parse_and_insert(self, file_path):
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Luật Cư trú 2020.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "68_2020_QH14_435315.docx")

    builder = LuatCuTruGraphBuilder(URI, USER, PASSWORD)
    try:
