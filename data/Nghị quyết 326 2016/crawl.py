...
class NghiQuyetGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Nghị quyết 326/2016/UBTVQH14
        self.base_id = "NghiQuyet_326_2016_UBTVQH14"
        self.common_props = {
    ...
    def parse_and_insert(self, file_path):
        ...
        # Thông tin của node gốc NghiQuyet
        nghi_quyet_info = {
            "id": self.base_id,
            "so_hieu": "326/2016/UBTVQH14",
            "ten_van_ban": "Nghị quyết quy định về mức thu, miễn, giảm, thu, nộp, quản lý và sử dụng án phí và lệ phí Tòa án",
            "co_quan_ban_hanh": "Ủy ban Thường vụ Quốc hội",
            "noidung": "Nghị quyết quy định về mức thu, miễn, giảm, thu, nộp, quản lý và sử dụng án phí và lệ phí Tòa án"
        }
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Nghị quyết 326/2016.")

    @staticmethod
    def _upsert_nghi_quyet(tx, info, common):
        query = """
        MERGE (nq:NghiQuyet {id: $info.id})
        SET nq.so_hieu = $info.so_hieu,
            nq.ten_van_ban = $info.ten_van_ban,
            nq.co_quan_ban_hanh = $info.co_quan_ban_hanh,
            nq.noidung = $info.noidung,
            nq.ngay_ban_hanh = $common.ngay_ban_hanh,
            nq.loai_van_ban = $common.loai_van_ban,
            nq.ngay_co_hieu_luc = $common.ngay_co_hieu_luc,
            nq.ngay_het_hieu_luc = $common.ngay_het_hieu_luc,
            nq.tinh_trang_hieu_luc = $common.tinh_trang_hieu_luc,
            nq.cap_bac_phap_ly = $common.cap_bac_phap_ly
        """
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "326_2016_UBTVQH14_337085.docx")
