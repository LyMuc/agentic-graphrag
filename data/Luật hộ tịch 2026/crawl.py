...
class LuatHoTichGraphBuilder:
    def __init__(self, uri, user, password):
        self.driver = GraphDatabase.driver(uri, auth=(user, password))
        
        # ID gốc và các thông tin chung của Luật Hộ tịch 2026
        self.base_id = "Luat_HoTich_2026"
        self.common_props = {
            "loai_van_ban": "Luật",
            "ngay_ban_hanh": "2026-04-23",
            "ngay_co_hieu_luc": "2027-03-01",
    ...
    def parse_and_insert(self, file_path):
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Luật Hộ tịch 2026.")
...
if __name__ == "__main__":
    ...
    # Đường dẫn file đã được cập nhật chuẩn
    FILE_PATH = os.path.join(base_dir, "03_2026_QH16_694806.docx")

    builder = LuatHoTichGraphBuilder(URI, USER, PASSWORD)
    try:
