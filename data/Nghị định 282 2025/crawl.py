...
class NghiDinhGraphBuilder:
    def __init__(self, uri, user, password):
        ...
        # ID gốc và các thông tin chung của Nghị định 282/2025/NĐ-CP
        self.base_id = "NghiDinh_282_2025_ND_CP"
        self.common_props = {
            "loai_van_ban": "Nghị định",
            "ngay_ban_hanh": "2025-10-30",
    ...
    def parse_and_insert(self, file_path):
        ...
        nghi_dinh_info = {
            ...
            "ten_van_ban": "Nghị định quy định xử phạt vi phạm hành chính trong lĩnh vực an ninh, trật tự, an toàn xã hội; phòng, chống tệ nạn xã hội; phòng, chống bạo lực gia đình",
            "co_quan_ban_hanh": "Chính phủ",
            "noidung": "Nghị định quy định xử phạt vi phạm hành chính trong lĩnh vực an ninh, trật tự, an toàn xã hội; phòng, chống tệ nạn xã hội; phòng, chống bạo lực gia đình"
        }
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Nghị định 282/2025/NĐ-CP.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "282_2025_ND-CP_679658.docx")
