...
class LuatNuoiConNuoiGraphBuilder:
    def __init__(self, uri, user, password):
        self.driver = GraphDatabase.driver(uri, auth=(user, password))
        
        # ID gốc và các thông tin chung của Luật Nuôi con nuôi 2010
        self.base_id = "Luat_nuoiconnuoi_2010"
        self.common_props = {
            "loai_van_ban": "Luật",
            "ngay_ban_hanh": "2010-06-17",
    ...
    def parse_and_insert(self, file_path):
        ...
        luat_info = {
            "id": self.base_id,
            "so_hieu": "52/2010/QH12",
            "ten_luat": "Luật Nuôi con nuôi",
        ...
        # Regex Chương được cập nhật để bắt cả số tự nhiên (Vd: Chương 1) và La Mã (Chương I)
        ...
        # Danh sách các biến thể kết thúc trích đoạn
        quote_endings = ['.".', ';".', '”.', ';”.', '.”.', ';”.', '."', ';"', '.”', ';”']
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Luật Nuôi con nuôi 2010.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "52_2010_QH12_108082.docx")

    builder = LuatNuoiConNuoiGraphBuilder(URI, USER, PASSWORD)
    try:
