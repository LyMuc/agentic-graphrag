...
class LuatGraphBuilder:
    def __init__(self, uri, user, password):
        self.driver = GraphDatabase.driver(uri, auth=(user, password))
        
        # ID gốc và các thông tin chung của Luật Phòng, chống bạo lực gia đình 2022
        self.base_id = "Luat_PhongChongBaoLucGiaDinh_2022"
        self.common_props = {
            "loai_van_ban": "Luật",
            "ngay_ban_hanh": "2022-11-14",
            "ngay_co_hieu_luc": "2023-07-01",
            "ngay_het_hieu_luc": "",
    ...
    def parse_and_insert(self, file_path):
        ...
        luat_info = {
            "id": self.base_id,
            "so_hieu": "13/2022/QH15",
            "ten_luat": "Luật Phòng, chống bạo lực gia đình",
        ...
        for line in lines:
            # XỬ LÝ TRONG TRÍCH ĐOẠN (Dành cho các điều sửa đổi bổ sung văn bản khác)
            if is_quoting:
                if active_entity:
            ...
            # NHẬN DIỆN CẤU TRÚC VĂN BẢN CHÍNH
        ...
        print(f"Đã hoàn tất bóc tách {len(articles)} Điều của Luật Phòng, chống bạo lực gia đình 2022.")
...
if __name__ == "__main__":
    ...
    FILE_PATH = os.path.join(base_dir, "13_2022_QH15_490095.docx")

    builder = LuatGraphBuilder(URI, USER, PASSWORD)
    try:
