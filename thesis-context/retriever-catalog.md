...
| `dai_dien_trach_nhiem_vo_chong` | `dai_dien_trach_nhiem_vo_chong` | `vo_chong` | `adapter/retrievers/quan_he_giua_vo_va_chong/dai_dien_trach_nhiem_vo_chong.py` | — |
...
| `ket_hon_trai_phap_luat` | `ket_hon_trai_phap_luat` | `ket_hon` | `adapter/retrievers/ket_hon/ket_hon_trai_phap_luat.py` | — |
| `quan_he_giua_cac_thanh_vien_khac_trong_gia_dinh` | `quan_he_giua_cac_thanh_vien_khac_trong_gia_dinh` | `family_members` | `adapter/retrievers/quan_he_giua_cac_thanh_vien_khac_trong_gia_dinh.py` | — |
| `quan_he_hon_nhan_co_yeu_to_nuoc_ngoai` | `quan_he_hon_nhan_co_yeu_to_nuoc_ngoai` | `foreign` | `adapter/retrievers/quan_he_hon_nhan_co_yeu_to_nuoc_ngoai.py` | — |
| `quy_dinh_chung_khai_niem_phap_ly` | `quy_dinh_chung_khai_niem_phap_ly` | `general` | `adapter/retrievers/quy_dinh_chung_khai_niem_phap_ly.py` | — |
...
| `quyen_nghia_vu_cha_me_con` | `quyen_nghia_vu_cha_me_con` | `cha_me_con` | `adapter/retrievers/quyen_nghia_vu_cha_me_con.py` | — |
| `quyen_nghia_vu_vo_chong` | `quyen_nghia_vu_vo_chong` | `vo_chong` | `adapter/retrievers/quan_he_giua_vo_va_chong/quyen_nghia_vu_vo_chong.py` | — |
| `tai_san_rieng_cua_con` | `tai_san_rieng_cua_con` | `cha_me_con` | `adapter/retrievers/tai_san_rieng_cua_con.py` | — |
| `xac_dinh_cha_me_con` | `xac_dinh_cha_me_con` | `cha_me_con` | `adapter/retrievers/xac_dinh_cha_me_con.py` | — |
| `xu_phat_vi_pham` | `xu_phat_vi_pham` | `vi_pham` | `adapter/retrievers/vi_pham/xu_phat_vi_pham.py` | — |
