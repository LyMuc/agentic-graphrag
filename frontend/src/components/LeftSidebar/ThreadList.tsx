...
export function ThreadList({
  ...
  const handleMoveThread = (threadId: string, projectId: string | null) => {
    toast.promise(apiClient.assignThread(threadId, projectId), {
      loading: "Moving chat",
      success: () => {
        setThreadHistory((prev) => ({
          ...prev,
      ...
      error: (err) =>
        err instanceof Error ? err.message : "Failed to move chat",
    });
  };
                            ...
                            <Link to={isResumed ? "" : `/thread/${thread.id}`}>
                              ...
                              >
                                ...
                                <ThreadOptions
                                  ...
                                  onMove={(projectId) =>
                                    handleMoveThread(thread.id, projectId)
                                  }
                                  className={cn(
