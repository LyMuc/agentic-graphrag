...
from adapter.cypher_templates.cha_me_con_sau_ly_hon.quyen_nghia_vu_chung_sau_ly_hon import (
    quyen_nghia_vu_chung_sau_ly_hon,
)
from adapter.cypher_templates.cha_me_con_sau_ly_hon.xac_dinh_nguoi_truc_tiep_nuoi_con import (
...
from adapter.cypher_templates.cha_me_con_sau_ly_hon.quyen_nghia_vu_nguoi_khong_truc_tiep_nuoi import (
    quyen_nghia_vu_nguoi_khong_truc_tiep_nuoi,
)
from adapter.cypher_templates.cha_me_con_sau_ly_hon.tham_nom_va_can_tro_tham_nom import (
    tham_nom_va_can_tro_tham_nom,
)
from adapter.cypher_templates.cha_me_con_sau_ly_hon.thay_doi_nguoi_truc_tiep_nuoi_con import (
