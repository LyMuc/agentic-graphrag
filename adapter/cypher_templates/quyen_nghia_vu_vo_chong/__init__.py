...
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.binh_dang_quyen_nghia_vu_vo_chong import (
    binh_dang_quyen_nghia_vu_vo_chong,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.bao_ve_quyen_nghia_vu_nhan_than import (
    bao_ve_quyen_nghia_vu_nhan_than,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.tinh_nghia_vo_chong import (
    tinh_nghia_vo_chong,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.nghia_vu_song_chung import (
    nghia_vu_song_chung,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.lua_chon_noi_cu_tru import (
    lua_chon_noi_cu_tru,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.ton_trong_danh_du_nhan_pham_uy_tin import (
    ton_trong_danh_du_nhan_pham_uy_tin,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.ton_trong_tu_do_tin_nguong_ton_giao import (
    ton_trong_tu_do_tin_nguong_ton_giao,
)
from adapter.cypher_templates.quyen_nghia_vu_vo_chong.ho_tro_hoc_tap_lam_viec_hoat_dong_xa_hoi import (
