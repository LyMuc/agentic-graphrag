...
from adapter.cypher_templates.dieu_kien_ket_hon.hon_nhan_cung_gioi_tinh import (
    hon_nhan_cung_gioi_tinh,
)
from adapter.cypher_templates.dieu_kien_ket_hon.do_tuoi_ket_hon import do_tuoi_ket_hon
from adapter.cypher_templates.dieu_kien_ket_hon.cac_truong_hop_cam_ket_hon import (
...
from adapter.cypher_templates.dieu_kien_ket_hon.quan_he_nuoi_duong_va_thong_gia_bi_cam import (
    quan_he_nuoi_duong_va_thong_gia_bi_cam,
)
from adapter.cypher_templates.dieu_kien_ket_hon.quan_he_thong_gia_khong_huyet_thong import (
    quan_he_thong_gia_khong_huyet_thong,
)
from adapter.cypher_templates.dieu_kien_ket_hon.xac_lap_quan_he_vo_chong_hop_phap import (
...
from adapter.cypher_templates.dieu_kien_ket_hon.yeu_to_xa_hoi_khong_phai_tro_ngai import (
    yeu_to_xa_hoi_khong_phai_tro_ngai,
)
from adapter.cypher_templates.dieu_kien_ket_hon.dieu_kien_ket_hon_tong_quat import (
