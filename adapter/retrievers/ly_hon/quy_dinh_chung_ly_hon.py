    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Câu hỏi cụ thể của người dùng về việc ly hôn, quyền ly hôn hoặc thủ tục ly hôn."
                }
            },
            "required": ["query"],
        },
...
async def quy_dinh_chung_ly_hon(query: str):
    """
    Tool xử lý các quy định chung về Ly hôn (Điều 51 - Điều 57).
    """
    ...
    - 'Luat_HNGD_2014_Dieu_51': Quyền yêu cầu giải quyết ly hôn.
    - 'Luat_HNGD_2014_Dieu_52': Khuyến khích hòa giải ở cơ sở.
    - 'Luat_HNGD_2014_Dieu_53': Thụ lý đơn yêu cầu ly hôn.
    - 'Luat_HNGD_2014_Dieu_54': Hòa giải tại Tòa án. (Sau khi thụ lý đơn yêu cầu ly hôn)
    - 'Luat_HNGD_2014_Dieu_55': Thuận tình ly hôn.
    - 'Luat_HNGD_2014_Dieu_56': Ly hôn theo yêu cầu của một bên. (Đơn phương ly hôn)
    - 'Luat_HNGD_2014_Dieu_57': Thời điểm chấm dứt hôn nhân và trách nhiệm gửi bản án, quyết định ly hôn
    ...
    try:
        ...
        target_ids, target_date, is_user_provide_date = ["Luat_HNGD_2014_Dieu_51", "Luat_HNGD_2014_Dieu_55", "Luat_HNGD_2014_Dieu_56"], formatted_date, False
