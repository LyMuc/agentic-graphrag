...
from adapter.cypher_templates.quan_he_hon_nhan_co_yeu_to_nuoc_ngoai import (
    QUAN_HE_HON_NHAN_CO_YEU_TO_NUOC_NGOAI_REGISTRY,
)
from adapter.cypher_templates.quan_he_hon_nhan_co_yeu_to_nuoc_ngoai.term_mapping import (
    resolve_term,
)
