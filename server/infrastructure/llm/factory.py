"""Factory + helper cho các LLM (Router / Retriever / Response) qua OpenAI API.

Tách từ ``adapter/config.py`` trong Phase 2 refactor (infrastructure layer):
build_llm, build_router_llm, build_retriever_llm, build_response_llm, chat,
chat_stream và retry logic streaming.
"""
import asyncio
import os
