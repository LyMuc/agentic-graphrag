...
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.bao_ve_quyen_nghia_vu_cha_me_con import (
    bao_ve_quyen_nghia_vu_cha_me_con,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.nghia_vu_quyen_cua_cha_me import (
    nghia_vu_quyen_cua_cha_me,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.quyen_nghia_vu_cua_con import (
    quyen_nghia_vu_cua_con,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.cham_soc_nuoi_duong_giua_cha_me_con import (
    cham_soc_nuoi_duong_giua_cha_me_con,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.giao_duc_con import (
    giao_duc_con,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.dai_dien_va_giao_dich_cho_con import (
    dai_dien_va_giao_dich_cho_con,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.boi_thuong_thiet_hai_do_con_gay_ra import (
    boi_thuong_thiet_hai_do_con_gay_ra,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.quyen_nghia_vu_cha_me_nuoi_con_nuoi import (
    quyen_nghia_vu_cha_me_nuoi_con_nuoi,
)
from server.infrastructure.neo4j.cypher_templates.quyen_nghia_vu_cha_me_con.quyen_nghia_vu_quan_he_gia_dinh_mo_rong import (
