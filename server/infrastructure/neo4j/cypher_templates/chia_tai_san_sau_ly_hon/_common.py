"""Common Cypher snippets + helpers cho topic Chia tài sản sau ly hôn (Đ59–64).

Tách khối Cypher 'vét cấu trúc + time-aware + huong_dan + bo_tro + hien_hanh'
ra để các template chia_tai_san_sau_ly_hon paste lại đồng nhất với schema cũ
...
THAY_THE_BOI có hướng (moi/cu) — tránh kéo anh em qua hub thay thế chung.
...
# Label Neo4j gắn trên node semantic thuộc topic chia tài sản sau ly hôn.
# Chỉ dùng cho MATCH node ngữ nghĩa (HanhVi, DieuKien, ...), KHÔNG áp dụng
