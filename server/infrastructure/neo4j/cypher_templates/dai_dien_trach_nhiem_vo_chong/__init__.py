...
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.can_cu_xac_lap_dai_dien import (
    can_cu_xac_lap_dai_dien,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.uy_quyen_giao_dich_can_dong_y import (
    uy_quyen_giao_dich_can_dong_y,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.dai_dien_khi_nang_luc_hanh_vi_bi_anh_huong import (
    dai_dien_khi_nang_luc_hanh_vi_bi_anh_huong,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.dai_dien_trong_quan_he_kinh_doanh import (
    dai_dien_trong_quan_he_kinh_doanh,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.dua_tai_san_chung_vao_kinh_doanh import (
    dua_tai_san_chung_vao_kinh_doanh,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.dai_dien_tai_san_chung_gcn_mot_ben import (
    dai_dien_tai_san_chung_gcn_mot_ben,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.hieu_luc_giao_dich_trai_dai_dien import (
    hieu_luc_giao_dich_trai_dai_dien,
)
from server.infrastructure.neo4j.cypher_templates.dai_dien_trach_nhiem_vo_chong.trach_nhiem_lien_doi_vo_chong import (
