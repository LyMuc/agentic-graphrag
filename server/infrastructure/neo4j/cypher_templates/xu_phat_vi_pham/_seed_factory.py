...
from server.infrastructure.neo4j.cypher_templates.xu_phat_vi_pham._common import (
    TOPIC,
    TOPIC_LABEL,
...
from server.infrastructure.neo4j.cypher_templates.xu_phat_vi_pham._hngd_dieu5 import (
