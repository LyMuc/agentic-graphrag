"""Common Cypher snippets + helpers cho topic Xử phạt vi phạm (xu_phat_vi_pham)."""
...
WHERE luat_whitelist.id IN wl
  AND any(l IN labels(luat_whitelist) WHERE l IN [
    'DieuLuat', 'DieuKhoanLuat', 'DieuKhoanDiemLuat', 'VanBanPhapLuat'
  ])
