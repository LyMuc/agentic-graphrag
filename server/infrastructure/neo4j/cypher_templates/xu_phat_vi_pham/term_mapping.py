...
COMMON_TO_LEGAL_TERMS: dict[str, dict[str, Any]] = {
    ...
    "dang_hanh_vi": {
        ...
        "chọn giới tính thai nhi": "lua_chon_gioi_tinh_thai_nhi",
        "lựa chọn giới tính thai nhi": "lua_chon_gioi_tinh_thai_nhi",
    ...
    "nhom_hanh_vi_bi_cam": {
        "điều 5 khoản 2": "tong_quat",
        "hành vi bị cấm": "tong_quat",
        "pháp luật cấm gì": "tong_quat",
        "kết hôn giả tạo hoặc ly hôn giả tạo bị cấm": "ket_hon_ly_hon_gia_tao",
        "tảo hôn bị cấm": "tao_hon_cuong_ep_can_tro_ket_hon",
        "ép cưới bị cấm": "tao_hon_cuong_ep_can_tro_ket_hon",
        "cản trở kết hôn bị cấm": "tao_hon_cuong_ep_can_tro_ket_hon",
        "ngoại tình bị cấm": "mot_vo_mot_chong",
        "vi phạm một vợ một chồng bị cấm": "mot_vo_mot_chong",
        "hôn nhân cận huyết bị cấm": "quan_he_hon_nhan_bi_cam",
        "thách cưới bị cấm": "yeu_sach_cua_cai",
        "yêu sách của cải bị cấm": "yeu_sach_cua_cai",
        "cưỡng ép ly hôn bị cấm": "cuong_ep_can_tro_ly_hon",
        "cản trở ly hôn bị cấm": "cuong_ep_can_tro_ly_hon",
        "sinh con thương mại bị cấm": "sinh_con_mang_thai_ho",
        "chọn giới tính thai nhi bị cấm": "sinh_con_mang_thai_ho",
        "bạo lực gia đình bị cấm": "bao_luc_gia_dinh",
        "lợi dụng quyền hôn nhân gia đình": "loi_dung_quyen_hngd_truc_loi",
        "mua bán người": "loi_dung_quyen_hngd_truc_loi",
        "bóc lột": "loi_dung_quyen_hngd_truc_loi",
        "trục lợi": "loi_dung_quyen_hngd_truc_loi",
    },
}
