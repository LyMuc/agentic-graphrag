...
from server.infrastructure.neo4j.cypher_templates.cap_duong.term_mapping import resolve_term
...
class CapDuongRetriever(RetrieverAgent):
    """Subagent ``cap_duong`` — thin wrapper ủy quyền pipeline classify→extract→execute→run."""
